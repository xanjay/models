...
"""Converts deepfashion2 data to TFRecord file format with Example protos."""
...
tf.app.flags.DEFINE_string(
    'train_image_folder',
    './deepfashion2/deepfashion2/images/train',
    'Folder containing trainng images')
tf.app.flags.DEFINE_string(
    'train_image_label_folder',
    './deepfashion2/deepfashion2/annotations/train',
    'Folder containing annotations for trainng images')

tf.app.flags.DEFINE_string(
    'val_image_folder',
    './deepfashion2/deepfashion2/images/val',
    'Folder containing validation images')

tf.app.flags.DEFINE_string(
    'val_image_label_folder',
    './ADE20K/ADEChallengeData2016/annotations/val',
    'Folder containing annotations for validation')

tf.app.flags.DEFINE_string(
    'output_dir', './deepfashion2/tfrecord',
...
def _convert_dataset(dataset_split, dataset_dir, dataset_label_dir):
  """Converts the deepfashion2 dataset into into tfrecord format.
